...
! 4 5 6  5
   ...
   write(*,'(3x,"wedge: ")',advance='no') ; read(*,*)wedge(1:3,1:6)
   
   do iSide=1,5
     
     select case(iSide)
     case(1) ; nod(1:4)=[1,2,5,4] ; print '("# xyz=",4(3(i2,",")," ; ")$)',int(wedge(1:3,nod(1:4)))
     case(2) ; nod(1:4)=[2,3,6,5] ; print '("# xyz=",4(3(i2,",")," ; ")$)',int(wedge(1:3,nod(1:4)))
     case(3) ; nod(1:4)=[3,1,4,6] ; print '("# xyz=",4(3(i2,",")," ; ")$)',int(wedge(1:3,nod(1:4)))
     case(4) ; nod(1:3)=[1,3,2]   ; print '("# xyz=",3(3(i2,",")," ; ")$)',int(wedge(1:3,nod(1:3)))
     case(5) ; nod(1:3)=[4,5,6]   ; print '("# xyz=",3(3(i2,",")," ; ")$)',int(wedge(1:3,nod(1:3)))
     end select
     
     pt1(1:3)=wedge(1:3,nod(1))
     pt2(1:3)=wedge(1:3,nod(2))
     pt3(1:3)=wedge(1:3,nod(3))
